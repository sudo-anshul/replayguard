...
[Live lab](https://prod.d2w687q4ucx6dk.amplifyapp.com) · [AWS comparison](https://prod.d2w687q4ucx6dk.amplifyapp.com/aws-key-scope.html) · [Download the regression kit](web/replayguard-repair-lab.zip) · [Watch the 2:34 demo](https://youtu.be/coCDLSyU8AY)
...
The current official submission cutoff is **September 20, 2026, 20:00 IST (14:30 UTC)**. A [fresh API check at 07:05 UTC on September 20](docs/publication/deadline-current-20260920.json) verified the configuration updated at `2026-09-20T04:57:05.393246Z`; this supersedes the earlier 09:00 IST guidance. Submit before the cutoff. The [deadline history](docs/deadline.md) and [submission package](docs/submission.md) retain the evidence, requirements and incomplete fields.

## Current narrated demo

[Watch the September 20 demo](https://youtu.be/coCDLSyU8AY): **2:34 (154.000 seconds)**, published unlisted, with Neha's English narration in an Indian accent. It shows the recorded AWS comparison, then actual local order-ID → SKU → order-ID edits, executions and report imports with explanatory animation. The [current script and chapters](docs/demo-script.md) separate AWS evidence from the local tutorial. The narrated master passed 17 technical and edit checks; the watch page displayed 2:34, and YouTube's copyright and Community Guidelines checks reported no issues. Direct perceptual listening was not available during the machine review.

The film retains the previously reviewed silent master's picture: 4,620 frames with documented reading holds. Its [rendering source](demo/silent-20260920/README.md) and [silent-release record](docs/releases/2026-09-20.md#media-and-publication) remain unchanged. The earlier **2:43 (163.033333-second)** film, its 19 technical checks and nine-frame review are separate historical evidence retained in the [September 19 script](docs/demo-script-v2.md) and [production record](docs/repair-lab/media/revision-2/README.md).
