...
Source commit [`0d0ec11ef4e3ba30ad03f2bd623f4e116d7ce664`](https://github.com/sudo-anshul/replayguard/commit/0d0ec11ef4e3ba30ad03f2bd623f4e116d7ce664) is published, with [anonymous pinned-file verification](releases/2026-09-20-github-public.json). The local companion source ZIP passed clean-extraction checks and byte-identical re-export; 676 repository files match that commit. Subsequent docs-only updates are separate from the tested source. [Hosted CI at that commit](releases/2026-09-20-github-ci.json) remains incomplete because the billing block prevented every step from starting; no hosted test failure or pass is claimed. The new local video does not replace the earlier published YouTube upload, and no new voice or YouTube upload was performed. The dated AWS and media records below remain unchanged in scope.
