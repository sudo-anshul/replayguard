...
The [new local demo](../../README.md#local-demo) is **163.064875 seconds (2:43)** and 4,979,581 bytes. Video decoding and audio checks passed; earlier MP4s remain unchanged. It combines actual UI captures and recorded local executions with narration. The companion MP4's SHA-256 is `582537a547ff08a1cfd1118a60b8784a07bfe7d854974aa3abd0a4e2bf580339`. The current YouTube publication status is recorded separately.
