...
The current official submission cutoff is **September 20, 2026, 20:00 IST (14:30 UTC)**. The [September 20, 07:05:26 UTC API check](../publication/deadline-current-20260920.json) verified the configuration updated at `2026-09-20T04:57:05.393246Z`. This supersedes the earlier 09:00 IST guidance; [deadline history](../deadline.md) is preserved.

**Historical observation, superseded by the current configuration above:** the [September 19, 04:12 UTC read-only refresh](../deadline-refresh-20260919.json) confirmed the same earlier API cutoff. The refreshed overview response supplied no end time, leaving the discrepancy unresolved. No AWS API was used for this check.
